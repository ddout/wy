...
import com.ddout.fb.dao.buss.IBussIssueMapper;
...
@Service
public class BussIssueServiceImpl implements IBussIssueService {
    @Autowired
    private IBussIssueMapper mapper;
	...
	for (int i = 0; i < items.size(); i++) {
	    ...
	    if("".equals(item.getString("purchaseid"))){
