 ...
 */
@Controller
@RequestMapping("/Buss/Storage")
public class BussStorageController {
    private static final Logger log = Logger.getLogger(BussStorageController.class);

    @Autowired
    private IBussStorageService service;
