...
import com.ddout.fb.service.buss.IFreightService;

@Controller
@RequestMapping("/Freight")
public class FreightController {
    private static final Logger log = Logger.getLogger(FreightController.class);

    @Autowired
    private IFreightService service;
