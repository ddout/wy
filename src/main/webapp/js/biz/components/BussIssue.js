...
Vue.component('comp-BussIssue', {
	...
	methods: {
		...
		addData:function(){
			this.$router.push({ name: 'compBussIssueView', params: { type:'add', id: '0' }});
		},
		updateData:function(_id){
			this.$router.push({ name: 'compBussIssueView', params: { type:'update', id: _id }});
		},
		viewData:function(_id){
			this.$router.push({ name: 'compBussIssueView', params: { type:'view', id: _id }});
		}
	},
	template:'\
		<div>\
